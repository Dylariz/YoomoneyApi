...
using YoomoneyApi.Models.OperationHistory;
using static System.Console;

namespace YoomoneyApi.History;
...
public class History
{
    ...
    /// Список операций.
    /// </summary>
    public IEnumerable<Operation.Operation>? Operations { get;}
        ...
        string? startRecord = null, int? records = null, bool? details = null)
    {
        try
        {
            ...
            if (data is not null)
            {
                ...
                {
                    Operations = data.operations.Select(operation => new Operation.Operation(
